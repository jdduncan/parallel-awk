...
void syminit(void)	/* initialize symbol table with builtin vars */
{
	...
	PARloc  = setsymtab("PARALLEL", "", 0.0, NUM, symtab);
	SIZEloc = setsymtab("SIZE", "", 1.0, NUM, symtab);
	RANKloc = setsymtab("RANK", "", 0.0, NUM, symtab);
